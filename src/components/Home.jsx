    ...
    <>
      ...
      >
        <motion.div
          ...
          className="max-w-xl text-base sm:text-lg md:mr-12 mb-6 md:mb-0"
        >
          <h1 className="text-2xl sm:text-3xl font-bold">Hi, I'm Sherin Perera</h1>
        ...
        <motion.img
          src="MyProffile.jpeg"
          alt="Profile"
          className="rounded-full mb-6 md:mb-0 md:ml-12 w-40 h-40 sm:w-60 sm:h-60 md:w-80 md:h-80 shadow-lg object-cover"
